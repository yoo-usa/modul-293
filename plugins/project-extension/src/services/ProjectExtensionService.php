...
namespace yoo\projectextension\services;
 ...
 * @since     1.0.0
 */
class ProjectExtensionService extends Component {
    // Public Methods
    // =========================================================================

    public function compileScss($scss): string {
        ...
        return str_replace($stringSearch, $stringReplace, $css);
    }
}
