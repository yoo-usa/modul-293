...
namespace yoo\projectextension\fields;

use yoo\projectextension\ProjectExtension;
use yoo\projectextension\assetbundles\projectextensionfieldfield\ProjectExtensionFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class ProjectExtensionField extends Field {
    // Public Properties
    // =========================================================================
    ...
    public static function displayName(): string {
        return Craft::t('project-extension', 'ProjectExtensionField');
    }
    ...
    public function getSettingsHtml(): string|null {
        ...
        return Craft::$app->getView()->renderTemplate(
            'project-extension/_components/fields/ProjectExtensionField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string {
        ...
        Craft::$app->getView()->registerAssetBundle(ProjectExtensionFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs(
            "$('#{$namespacedId}-field').ProjectExtensionProjectExtensionField(" . $jsonVars . ");"
        );

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'project-extension/_components/fields/ProjectExtensionField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
