...
namespace yoo\projectextension\records;
 ...
 * @since     1.0.0
 */
class ProjectExtensionRecord extends ActiveRecord {
    ...
    public static function tableName() {
        return '{{%projectextension_projectextensionrecord}}';
    }
}
